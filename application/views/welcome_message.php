...
<head>
    ...
    <!-- Font Awesome -->
    <link href="<?= base_url('assets/lib/fontawesome/css/all.min.css') ?>" rel="stylesheet">
...
<body>
    ...
    <script src="<?= base_url('assets/lib/jquery/jquery-3.4.1.min.js') ?>"></script>
    <script src="<?= base_url('assets/lib/bootstrap/bootstrap.bundle.min.js') ?>"></script>
